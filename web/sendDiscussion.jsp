    ...
    <div class="ui main text container" style="margin-top: 70px;position:relative;" id="main">
        ...
        <div class="ui equal width stackable internally celled grid">
            ...
            <div class="row center aligned">
                <a style="display: inline" class="ui blue large button" onclick="sub()">发布帖子</a>
            </div>
        </div>
        <p></p>
        <p></p>
...
<script>
    function sub() {
        if ( $(" input[ name='title' ] ").val() == "" ||tinymce.get('mytextarea').getContent()=="" ) {
